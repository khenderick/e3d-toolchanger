...
G53 G1 X85 Y140 F50000  ; Move to border no-go zone
M400
...
M400  ; Wait for all moves to finish
if sensors.gpIn[4].value = 0 || sensors.gpIn[1].value = 1
  T-1 P0  ; Deselect all tools
  abort "Tool 1 was not correctly released"
