...
G53 G1 X-5.2 Y200 F50000  ; Move to border no-go zone
M400
...
M400  ; Wait for all moves to finish
if sensors.gpIn[1].value = 0 || sensors.gpIn[3].value = 1
  T-1 P0  ; Deselect all tools
  abort "Tool 0 was not correctly picked up"

G53 G1 Y156 F4000  ; Move to border no-go zone

M208 X-11.2:288.8 Y-44.3:155.7 Z7:300  ; Set limits with tool
